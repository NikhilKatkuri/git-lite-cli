...
`;
            ...
            const unknownGitIgnoreContent = `
# Generic .gitignore for unknown projects
# Common sensitive files and folders to ignore
...
`;
            ...
            fs.writeFileSync(filepath, unknownGitIgnoreContent.trim());
            console.log(`✅ .gitignore  written manually at ${filepath}`);
            return;
        }
